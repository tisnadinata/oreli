...
<fieldset>
	<legend><?php _e('Update'); ?></legend>
		<br><div class="row">
			<?php if (!$settings->newChangelog()) : ?>
				<div class="col-md-8 alert alert-block alert-warning fade in"><a class="close" data-dismiss="alert" href="#">&times;</a><h4 class="alert-warning"><?php _e('Updates disabled'); ?></h4>
				...
				<div class="col-md-8 alert alert-block alert-info fade in"><a class="close" data-dismiss="alert" href="#">&times;</a><h4 class="alert-info"><?php _e('Update available!'); ?></h4>
				<?php _e('There\'s a new update available! Please visit your CodeCanyon profile to download the new version.'); ?></div>
				<?php else : ?>
				<div class="col-md-8 alert alert-block alert-success fade in"><a class="close" data-dismiss="alert" href="#">&times;</a><h4 class="alert-success"><?php _e('You\'re up to date!'); ?></h4>
				<?php _e('There are no new updates available. When a new update is released this message will change accordingly.'); ?></div>
			<?php endif; ?>
		</div>

	<div class="form-group">
		<label class="control-label" for="update-check-enable"><?php _e('Check for updates'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('Disabling this may improve speed on the Settings page'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
	...
	<div class="form-group">
		...
		<div class="controls">
			<textarea rows="10" class="col-md-5" disabled><?php echo $settings->newChangelog(); ?></textarea>
		</div>
	</div>
