...
<fieldset>
	...
	<div class="form-group">
		<label class="control-label" for="email-activate-resend-subj"><?php _e('Resend link'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('The email a user receives when requesting an activation link.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
	...
	<div class="form-group">
		<label class="control-label" for="email-activate-subj"><?php _e('Activated'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('The email a user receives after activating their account.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
