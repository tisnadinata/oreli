...
<fieldset>
	...
	<div class="form-group">
		<label class="control-label" for="email-forgot-subj"><?php _e('Recover request'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('The email a user receives when requesting their username / password.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
	...
	<div class="form-group">
		<label class="control-label" for="email-forgot-success-subj"><?php _e('Recovered'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('The email a user receives after successfully resetting their password.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
