...
<fieldset>
	...
	<div class="form-group">
		<label class="control-label" for="email-acct-update-subj"><?php _e('Verify change'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('The email a user receives when updating an email or password.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
	...
	<div class="form-group">
		<label class="control-label" for="email-acct-update-success-subj"><?php _e('Updated'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('The email a user receives after confirming the account change.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
