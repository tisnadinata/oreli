...
<fieldset>
	...
	<div class="form-group">
		<label class="control-label" for="email-add-user-subj"><?php _e('Add user'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('When the admin creates a new user through the admin panel, the user will receive this email.'); ?>"><i class="glyphicon glyphicon-question-sign"></i></a></label>
		<div class="controls">
			<label>
