...
?>
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="controls">
				<input id="level_level" class="form-control input-mini" name="level_level" type="number" min="0" <?php if (!empty($Edit_level->isAdmin)) echo 'disabled'; ?> value="<?php echo $Edit_level->getValue('level_level'); ?>"/>
			</div>
		</div>
